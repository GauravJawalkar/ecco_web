    ...
    return (
        <section className='flex items-center justify-center min-h-screen '>
            <div className='w-[500px] flex items-center flex-col justify-center px-10 py-16 rounded-xl dark:bg-white/5 bg-slate-600/5 backdrop-blur-md'>
                <div>
                    <h1 className='text-center text-3xl capitalize font-semibold py-4'>🔒 Login 🔑</h1>
                </div>


                <div className='w-full py-2 flex items-center justify-center'>
                    <button className='py-1 min-w-full px-4 gap-3 rounded ring-1 ring-gray-200 hover:ring-2 flex items-center justify-center dark:ring-neutral-700'
