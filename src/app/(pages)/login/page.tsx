    ...
    return (
        <section className='flex items-center justify-center min-h-screen '>
            <div className='w-[500px] flex items-center flex-col justify-center px-10 py-16 rounded-xl dark:bg-white/5 bg-slate-600/5 backdrop-blur-md'>
                <h1 className='text-center text-4xl uppercase font-semibold py-4'>Login</h1>


                <div className='w-full py-2 flex items-center justify-center'>
                    <button className='py-1 min-w-full px-4 gap-3 rounded ring-1 ring-gray-200 hover:ring-2 flex items-center justify-center'
                ...
                <div className='relative w-full text-center py-2'>
                    <span className='bg-slate-600/5 rounded-full'>OR</span>
                    <span className='h-[2px] w-full bg-slate-600/5  absolute right-0 top-1/2 bottom-1/2 -z-10 mx-auto'></span>
                </div>
                <form onSubmit={(e) => { e.preventDefault(); handelSubmit() }} className='flex items-center justify-center gap-5 py-2 flex-col min-w-full'>
