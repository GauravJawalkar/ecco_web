...
const Store = () => {
    ...
    return (
        <section className="relative w-full mx-auto rounded-xl my-5">
            ...
            {/* Profile + Info Row */}
            <div className="flex items-center gap-4 z-10 my-5">
                {/* Profile Image */}
                <div className="w-32 h-32 rounded-full border-4 border-white dark:border-neutral-900 bg-white dark:bg-neutral-900">
                    <Image
                        alt="Store Profile"
                        src={StoreData?.[0]?.storeImage || `https://dummyimage.com/qvgaStoreData?.[0]?.storeCoverImage`}
                        width={1280}
                        height={1280}
                ...
                <div className="flex flex-col justify-center space-y-1">
                    ...
                    <div>
                        <p
                            className={`text-[15px] text-gray-500 dark:text-gray-400 max-w-lg leading-tight font-normal transition-all ${showFullDescription ? '' : 'line-clamp-2'
                                }`}
                        >
