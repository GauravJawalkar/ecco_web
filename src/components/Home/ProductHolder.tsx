...
import MobileProductHolder from "./MobileProductHolder";
...
const ProductHolder = ({ rank, prodData, loading, tag, adImage }: { rank: number, prodData: any, loading: boolean, tag: string, adImage: string }) => {
  ...
  return (
    <>
      ...
      {/* Flipkart/Amazon Style Mobile View */}
      <div className="block lg:hidden w-full">
        <MobileProductHolder prodData={prodData} loading={loading} tag={tag} adImage={adImage} />
      </div>
    </>
  );
};
