                ...
                <div className="relative flex items-center justify-center text-neutral-300 group">
                    ...
                    ${dataLength === 0 ? "group-hover:hidden" : "block"}`}>
                        <div className="border-b-[0.1px]  dark:bg-neutral-900 bg-white rounded border dark:border-zinc-700 p-2 text-[#1a1a1a] dark:text-slate-200">
                            <Link href={'/profile'} className="py-1 flex items-center justify-start gap-2 hover:bg-gray-100 dark:hover:bg-[#5a5a5a] px-2 rounded text-[#1a1a1a] dark:text-slate-200 text-sm"> <Info className="text-[#1a1a1a] dark:text-slate-200 h-4 w-4 text-sm" />Account</Link>
                            ...
                            <div>
                                <button className="py-1 flex items-center justify-start gap-2 hover:bg-gray-100 dark:hover:bg-[#5a5a5a] px-2 rounded text-[#1a1a1a] dark:text-slate-200 text-sm w-full" onClick={() => { handelLogout() }}>
